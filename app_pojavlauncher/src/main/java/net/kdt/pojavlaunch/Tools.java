...
public final class Tools {
    ...
    public static String APP_NAME = "Chandra Launcher";
    ...
    public static String DIR_GAME_HOME = Environment.getExternalStorageDirectory().getAbsolutePath() + "/games/Chandra Launcher";
    ...
    private static File getPojavStorageRoot(Context ctx) {
        if(SDK_INT >= 29) {
            ...
            return new File(Environment.getExternalStorageDirectory(),"games/Chandra Launcher");
        }
    }
